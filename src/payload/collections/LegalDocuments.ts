...
// ---------------------------------------------------------------------------
// Закрытое хранилище документов юр. проверки объектов (модуль «Юридическая
// проверка объекта» в CRM). Файлы хранятся base64 в БД (как вложения писем,
...
export const LegalDocuments: CollectionConfig = {
  ...
  labels: { singular: 'Документ юр. проверки', plural: 'Документы юр. проверки' },
  admin: {
    hidden: true,
