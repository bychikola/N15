...
async function getContacts() {
  ...
  // Email
  if (s.email) {
    contacts.push({ label: 'Email', value: s.email, href: `mailto:${s.email}` })
  }
  ...
  // Address
  if (s.address) {
    contacts.push({ label: 'Адрес', value: s.address, href: null })
  }
