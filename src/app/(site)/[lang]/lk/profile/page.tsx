        ...
        <SectionWrapper variant="dark">
          ...
          <div className="max-w-lg">
            ...
            <form className="flex flex-col gap-4">
              ...
              <input type="email" defaultValue="al@n15.ru" placeholder={t.lkProfile.email} className="bg-[var(--n15-black)] border border-[var(--n15-gold)]/20 px-4 py-2.5 text-sm text-[var(--n15-silver)] focus:outline-none focus:border-[var(--n15-gold)]/50" />
