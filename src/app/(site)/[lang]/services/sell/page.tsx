...
export default async function SellPage({ params }: PageProps) {
  ...
  const steps = [
    { step: '01', title: t.services.sell.step1Title, desc: t.services.sell.step1Desc },
    { step: '02', title: t.services.sell.step2Title, desc: t.services.sell.step2Desc },
    { step: '03', title: t.services.sell.step3Title, desc: t.services.sell.step3Desc },
  ]
    ...
    <>
      ...
      <main className="pt-20">
        <SectionWrapper variant="dark" ornament="solar">
          <h1 className="text-4xl md:text-5xl font-[family-name:var(--font-display)] text-[var(--n15-white)] mb-4">{t.services.sell.title}</h1>
          <p className="text-[var(--n15-muted)] max-w-2xl mb-8">
            {t.services.sell.subtitle}
          </p>
        </SectionWrapper>
        <SectionWrapper variant="charcoal">
          ...
          <div className="text-center">
            <Button variant="primary" href={`/${lang}/contacts`}>{t.services.sell.cta}</Button>
          </div>
        </SectionWrapper>
      </main>
      <Footer />
