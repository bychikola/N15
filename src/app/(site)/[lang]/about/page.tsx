...
// Чем занимается агентство — семь направлений. В сетке из четырёх колонок
// они ложатся как 4 + 3: блок остаётся компактным и не вытягивается вниз
  ...
  return (
    <>
      ...
      <main className="pt-20">
        ...
        {/* Чем занимается агентство: семь карточек одного размера — в четырёх
            колонках они ложатся как 4 + 3, без крупных отступов */}
