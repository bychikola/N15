// Вертикальный список услуг внутри страницы направления раздела «Услуги».
// Каждая услуга — отдельная строка со своим id: якорь позволяет открыть
// страницу сразу на нужной услуге (например /services/legal#proverka-obekta).
