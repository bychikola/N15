...
// интерьера, строительство частных домов, оценка): приветствие, полный
// перечень услуг внутри направления — каждая строка со своим якорем, —
// затем необязательный дополнительный блок и призыв к консультации.
