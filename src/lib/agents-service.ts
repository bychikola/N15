 ...
 * явным списком полей — без собственника, его телефона и кадастровых
 * номеров (ownerName, ownerPhone, cadastralNumber, plotCadastralNumber и
 * сведения участка — только администратор, см. Objects.ts), без внутренних
 * комментариев архива и без отчётов
