 ...
 * (агенту — только его собственные, см. «Права» ниже).
 *
 ...
 * окончательно» доступно только администратору. Список ниже читается целиком
 * (overrideAccess), поэтому строки чужого архива агенту отсекает страница
 * раздела по тем же признакам — см. src/app/crm/archive/page.tsx. Внутренние
