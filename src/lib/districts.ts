...
// Города категории «Участок»: земельные участки Н15 — только Владикавказ.
// Межрегиональных направлений (Москва, Химки…) у участков нет, поэтому в
// фильтре «Город» каталога для них остаются «Любой» и «Владикавказ»
// (см. CatalogFilters); остальные населённые пункты республики и садовые
// товарищества ищутся своими фильтрами — LOCALITIES_BY_DISTRICT и
// GARDENING_AREAS ниже
export const LAND_CITY_OPTIONS = ['Владикавказ'] as const
